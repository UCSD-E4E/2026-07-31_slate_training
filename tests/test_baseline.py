"""Pure-logic tests for the classical baseline's geometry helpers."""

import cv2
import numpy as np
import pytest

from slate_training.baseline import (
...
class TestRescaleHomography:
    ...
    def test_unit_scales_are_a_no_op(self):
        from slate_training.baseline import rescale_homography
...
class TestRefineAtFullRes:
    ...
    def test_recovers_a_perturbed_homography(self):
        from slate_training.baseline import refine_at_full_res
...
class TestTemplatePatternQuad:
    ...
    def test_dark_pixel_fallback_spans_the_whole_page(self):
        ...
        from slate_training.baseline import template_pattern_quad
...
class TestShrinkToPattern:
    ...
    def test_unit_ratio_is_identity(self):
        from slate_training.baseline import shrink_to_pattern
